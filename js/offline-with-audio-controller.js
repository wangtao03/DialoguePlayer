    ...
    methods: {
        ...
        setOffset() {
            ...
            let timer = setInterval(() => {
                this.duration = this.audio.currentTime * 1000;
                this.updateTime();
                if (count == 0) {
                    clearInterval(timer)
                } else {
        ...
        setActiveIndex(index) {
            // this.duration = this.lyricsArray[index+1].timestamp;
            this.audio.currentTime = (this.lyricsArray[index].timestamp + 10) / 1000;
